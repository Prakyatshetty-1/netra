...
| `provenance_service` | SHA-256 append-only JSON-lines “ledger” |
...
- **No PDF / OCR ingestion** — the prototype reads structured rows already in `netra_sim.db`. A document pipeline would sit in front of this in a full build.
